	    ...
	    <ModalBody>
	    	<Form>
	    		<FormGroup>
	    			...
	    			<Input type = 'textarea' placeholder = 'Quote Goes Here' id = 'text' value = { newQuote.text } onChange = {handleChange}> </Input>
	    			<br></br>
	    			<Label for = 'by'> By </Label>
	    			<Input type = 'text' placeholder = 'Who Said It' id = 'by' value = { newQuote.by } onChange = {handleChange}> </Input>
	    			<br></br>
	    			<Label for = 'year'> Year </Label>
	    			<Input type = 'number' placeholder = 'When did they say it' id = 'year' value = { newQuote.year } defaultValue = { currentYear } onChange = {handleChange}> </Input>
	    			<br></br>
